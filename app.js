...
var shiver = new Float32Array(2);
shiver[0] = 0.25; //amplitude
shiver[1] = 0; //phase
var shiverStep = 1;
...
//  if(angle < -120.0 && ANGLE_STEP < 0) ANGLE_STEP = -ANGLE_STEP;
  ...
  if(shiverStep > 0 && shiver[1] > 2*Math.PI) shiverStep = -shiverStep;
  if(shiverStep < 0 && shiver[1] < 0) shiverStep = -shiverStep;
  shiver[1] += shiverStep * elapsed / 1000.0;
